    ...
    return (
        <Flex bgColor={'white'} h={'100vh'} flexDirection={'column'}>
            ...
            <Stack direction={'column'}>
                ...
                <Input type="text" placeholder="이름" onChange={(e) => setInputData({ ...inputData, name: e.target.value })} />
                <Input isInvalid={!isPasswordValid} borderColor={isPasswordValid ? 'gray.200' : '#da4359'} type="password" placeholder="비밀번호" onChange={(e) => { setPassword(e.target.value); validatePassword(e.target.value) }} />
                <Input isInvalid={!isPasswordValid} borderColor={isPasswordValid ? 'gray.200' : '#da4359'} type="password" placeholder="비밀번호 확인" onChange={(e) => { setConfirmPassword(e.target.value); validatePassword(e.target.value) }} />
                <HStack>
                ...
                <Input type="text" placeholder="상세주소" onChange={(e) => setInputData({ ...inputData, detail_address: e.target.value })} />
                <HStack>
